            ...
            <div className="animate-message-reveal">
              <form onSubmit={handleIdentifierSubmit} className="flex flex-col gap-4">
                ...
                <button 
                  ...
                  className="mt-4 flex items-center justify-center gap-2 w-full bg-[#ffffff] text-black font-semibold py-3.5 rounded-xl hover:bg-[#f4f4f5] transition-all disabled:opacity-50 disabled:hover:bg-[#ffffff] cursor-pointer shadow-[0_0_20px_rgba(255, 255, 255,0.15)] hover:shadow-[0_0_30px_rgba(255, 255, 255,0.3)]"
                >
          ...
          {step === "otp" && (
            <div className="animate-message-reveal flex flex-col items-center">
              <div className="flex justify-center gap-2 md:gap-3 mb-8 mt-4 w-full">
                {otp.map((digit, idx) => (
                  <input
                    ...
                    className={`w-10 h-12 md:w-12 md:h-14 bg-transparent border-b-2 border-[#27272a] focus:border-[#ffffff] focus:text-[#ffffff] focus:shadow-[0_4px_16px_rgba(255, 255, 255,0.15)] text-center text-2xl font-mono text-white outline-none transition-all ${digit ? 'border-[#ffffff]/50 text-[#ffffff]' : ''}`}
                  />
                ))}
              </div>
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#ffffff] text-black font-semibold py-3.5 rounded-xl hover:bg-[#f4f4f5] transition-all disabled:opacity-50 disabled:hover:bg-[#ffffff] cursor-pointer shadow-[0_0_20px_rgba(255, 255, 255,0.15)] hover:shadow-[0_0_30px_rgba(255, 255, 255,0.3)]"
              >
